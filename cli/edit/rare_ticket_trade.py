from __future__ import annotations                    from bcps import core
...
from bcps.cli import color, dialog_creator
    ...
    def rare_ticket_trade(save_file: core.SaveFile):
        ...
        space = False                                         for storage_item in save_file.cats.storage_items:                                                               if storage_item.item_type == 0 or (
        ...
        color.ColoredText.localize(                               "rare_ticket_successfully_traded", rare_ticket_count=to_add
)
