...
from bcps import core
    ...
    def get(self, stream: bool = False) -> requests.Response | None:
        ...
        try:                                                      return requests.get(
                ...
                timeout=core.core_data.config.get_int(                    core.ConfigKey.MAX_REQUEST_TIMEOUT
                ),
                stream=stream,                                    )                                                 except requests.exceptions.ConnectionError:
            return None

    def post(self) -> requests.Response | None:               """Sends a POST request.
